...
namespace OrderApplicationServer.Web.Data.Migrations
{
    ...
    [Migration("20211220090412_iinitial")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "03680d48-eae8-4e57-a44f-debde61e331f",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "51290a00-75c5-4f92-b3b3-92287205be54",
                            Name = "Admin",
            ...
            modelBuilder.Entity("OrderApplicationServer.Web.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "8160ba0e-a346-43aa-8810-2ad9da93a4af",
                            Created = new DateTime(2021, 12, 20, 10, 4, 11, 609, DateTimeKind.Local).AddTicks(7890),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAm/R8BcByNqwzTp33CaVCcP1hZ5bxV2EJcuZxisZjADJUkHlF5u/toUsTvQwgMA4g==",
                            PhoneNumber = "+1111111111",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "d04ee2db-7e93-430e-a7a5-e9c9a3f53e5b",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Birthdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ConcurrencyStamp = "62699e39-c253-4548-b6a7-3cf608e595a6",
                            Created = new DateTime(2021, 12, 20, 10, 4, 11, 609, DateTimeKind.Local).AddTicks(7949),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEArZjn8t2hPQ8soAO3h/fxvMStTLjMuFbhr45vmGGU+Bj+VcqwD9gxJiekup4th1fQ==",
                            PhoneNumber = "+222222222",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "f065ed62-ff97-4ef6-a49f-e16e587c63c4",
                            TwoFactorEnabled = false,
                            UserName = "bbrot"
                        });
                });
            ...
            modelBuilder.Entity("OrderApplicationServer.Web.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            OrderDate = new DateTime(2021, 12, 20, 10, 4, 11, 628, DateTimeKind.Local).AddTicks(5854),
                            UserId = "z65dbe81-22b1-4479-j58g-d730ap050aa1"
                        },
                        new
                        {
                            OrderId = 2,
                            OrderDate = new DateTime(2021, 12, 20, 10, 4, 11, 628, DateTimeKind.Local).AddTicks(5911),
                            UserId = "435dbe81-22b1-4479-bea2-d730a7750aa1"
                        },
                        new
                        {
                            OrderId = 3,
                            OrderDate = new DateTime(2021, 12, 20, 10, 4, 11, 628, DateTimeKind.Local).AddTicks(5914),
                            UserId = "z65dbe81-22b1-4479-j58g-d730ap050aa1"
                        },
                        new
                        {
                            OrderId = 4,
                            OrderDate = new DateTime(2021, 12, 20, 10, 4, 11, 628, DateTimeKind.Local).AddTicks(5917),
                            UserId = "z65dbe81-22b1-4479-j58g-d730ap050aa1"
                        },
                        new
                        {
                            OrderId = 5,
                            OrderDate = new DateTime(2021, 12, 20, 10, 4, 11, 628, DateTimeKind.Local).AddTicks(5920),
                            UserId = "435dbe81-22b1-4479-bea2-d730a7750aa1"
                        },
                        new
                        {
                            OrderId = 6,
                            OrderDate = new DateTime(2021, 12, 20, 10, 4, 11, 628, DateTimeKind.Local).AddTicks(5922),
                            UserId = "435dbe81-22b1-4479-bea2-d730a7750aa1"
                        });
                });
